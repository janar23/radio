 ...
 */
public class SampleRadioButtonReceiver extends BroadcastReceiver {
    private static final String TAG = "SampleMediaButtonReceiver";
    private static RadioActivity mActivity;

    public static void setActivity(RadioActivity activity) {
        mActivity = activity;
    }
