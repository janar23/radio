...
import com.example.android.mediarouter.player.RadioPlayer.RadioPlayerCallback;
 ...
 */
public class RadioSessionManager implements RadioPlayerCallback {
    ...
    public RadioSessionManager(String name) {
        mName = name;
    }
